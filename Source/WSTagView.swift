...
open class WSTagView: UIView {
    ...
    public init(tag: WSTag) {
        ...
        textLabel.frame = CGRect(x: tagMargins.left, y: tagMargins.top, width: 0, height: 0)
        textLabel.font = font
    ...
    open override var intrinsicContentSize: CGSize {
        ...
        return CGSize(width: labelIntrinsicSize.width + tagMargins.left + tagMargins.right,
                      height: labelIntrinsicSize.height + tagMargins.top + tagMargins.bottom)
    }
    
    open override func sizeThatFits(_ size: CGSize) -> CGSize {
        let layoutMarginsHorizontal = tagMargins.left + tagMargins.right
        let layoutMarginsVertical = tagMargins.top + tagMargins.bottom
    ...
    open override func layoutSubviews() {
        ...
        textLabel.frame = UIEdgeInsetsInsetRect(bounds,tagMargins)
